    ...
    <section className="container-content py-16">
      <Reveal>
        <SectionHeading
          label="contact"
          title="Hubungi Saya"
          description="Terbuka untuk kolaborasi, proyek, atau sekadar diskusi teknis."
        />
      </Reveal>
        ...
        <Reveal delay={80}>
          {sent ? (
            <div className="card border-accent/30 p-8 text-center">
              ...
              <p className="text-base font-medium text-mist-50">Pesan terkirim</p>
              <p className="mt-2 text-sm text-mist-400">Terima kasih, saya akan segera membalas.</p>
